...
def index():
    ...
    if form.validate_on_submit():
        ...
        if user is None:
            ...
            print('api: ' + str(app.config['API_KEY']), flush=True)
            print('from: ' + str(app.config['API_FROM']), flush=True)
            print('to: ' + str([app.config['FLASKY_ADMIN'], "matheusdejesusf@gmail.com", "flaskaulasweb@zohomail.com"]), flush=True)
            ...
            if app.config['FLASKY_ADMIN']:
                ...
                send_simple_message([app.config['FLASKY_ADMIN'], "matheusdejesusf@gmail.com", "flaskaulasweb@zohomail.com"], 'Novo usuário', form.name.data)
